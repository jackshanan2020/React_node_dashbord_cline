...
import { InventoryToolbar, InventoryMoreMenu }
  from '../inventory';
import TableHeader from '../../../components/table/TableHeader';
import InventoryProductListFilterForm from '../inventory/InventoryProductListFilterForm';
...
export default function ListExpenses() {
  ...
  useEffect(() => {
    setRequesting(true);
    (async function () {
      const res = await window.api.getAllExpenses();
      console.log(res)
      setList(res);
      setData(res);
      formatCSV(res);
  ...
  const handleDelete = async (rowId) => {
    try {
console.log(rowId)
      const res = await window.api.deleteExpenses({id:rowId});
      if (res) {
  ...
  return (
    <Page title="List Expenses">
      <Container>
        ...
        <Modal open={editOpen} close={toggleEditModal}>
          <Box>
            <EditExpensesForm expense={expenseSelected} close={toggleEditModal} />
          </Box>
        </Modal>
              ...
              <Table>
                ...
                <TableBody>
                  {LIST.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, date, createdAt, title, details, reference, amount, account, category } = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <TableMoreMenu rowId={id} handleDelete={handleDelete} edit={toggleEditModal} toggle={toggleEditModal}/>
                        </TableCell>
                      </TableRow>
                    );
                  })}
