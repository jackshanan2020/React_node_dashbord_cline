...
//  date,reference,customer,paid,grand total,created at,created by,total,item tax,order tax,discount,shipping,grand total,details
//  purchases report : '' supplier
//  Quantity alerts : name,code,total quantity,location quantity, low alert,rack location
//  items report : created at, purchase amount, puchased,sold amount,sold,name,code,
//  top products : code, name/title, sold,
//  
//  Expenses report : title,approval, approved, createdBy,createdAt, account, category, amount, details,
// activity log : createdAt, log name, description, by,
// ------------------------------------------------------------------
              ...
              <Table>
                ...
                <TableBody>
                  {products.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, date,createdAt,title,brand,price,quantity,unit,sku,availability} = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{format(new Date(createdAt), '../../MM/yyyy')}</TableCell>
                        <TableCell align="right">
                          <InventoryMoreMenu rowId={id} handleDelete={handleDelete}/>
                        </TableCell>
                      </TableRow>
                    );
                  })}
