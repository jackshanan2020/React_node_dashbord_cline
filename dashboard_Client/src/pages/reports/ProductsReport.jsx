...
import { InventoryHead, InventoryToolbar, InventoryMoreMenu } from '../../sections/@dashboard/inventory';
...
const TABLE_HEAD =[
 ...
 { id: 'soldAmount', label: 'Sold Amount', alignRight: false },
 { id: 'purchased', label: 'Purchased', alignRight: false },
 { id: 'purchasedAmount', label: 'Purchased Amount', alignRight: false },
 { id: 'createdAt', label: 'Created at', alignRight: false },
 { id: '' }
];
// ---name,code, sold, sold amount, purchased, purchased amount,createdAt
...
export default function ProductsReport() {
  ...
  useEffect(()=>{
    setRequesting(true);
      (async function(){
        const res = await window.api.getStocks();
        setList(res); 
        setData(res);
        formatCSV(res);
        setRequesting(false);
              ...
              <Table>
                ...
                <TableBody>
                  {LIST.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id,name,code,sold,soldAmount,purchased,purchasedAmount,createdAt} = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{soldAmount}</TableCell>
                        <TableCell align="left">{purchased}</TableCell>
                        <TableCell align="left">{purchasedAmount}</TableCell>
